...
(test_pkey_to_authorized_keys)
{
    ...
    while (fgets(line_buffer, sizeof line_buffer, fh_oneliner) != NULL) {
        ...
        strncat(exp_ssh_rsa, " ", sizeof exp_ssh_rsa -
...
make_util_suite(void)
{
    ...
    /* helper test cases */
    tcase_add_exit_test(tc_helper, test_substitute_token_exit_subst_NULL,
                        EXIT_FAILURE);
    tcase_add_exit_test(tc_helper, test_substitute_token_exit_src_NULL,
                        EXIT_FAILURE);
    tcase_add_exit_test(tc_helper, test_substitute_token_exit_dst_NULL,
                        EXIT_FAILURE);
    tcase_add_exit_test(tc_helper,
                        test_substitute_token_exit_subst_src_dst_NULL,
                        EXIT_FAILURE);
    int length_pe_lt = sizeof test_substitute_token_lt /
                       sizeof test_substitute_token_lt[0];
    tcase_add_loop_test(tc_helper, test_substitute_token, 0, length_pe_lt);

    int length_clsf_lt = sizeof test_create_ldap_search_filter_lt /
                         sizeof test_create_ldap_search_filter_lt[0];
    tcase_add_loop_test(tc_helper, test_create_ldap_search_filter, 0,
                        length_clsf_lt);

    tcase_add_exit_test(tc_helper, test_config_lookup_exit_key_NULL,
                        EXIT_FAILURE);
    tcase_add_test(tc_helper, test_config_lookup);

    tcase_add_exit_test(tc_helper, test_set_log_facility_exit_lf_in_NULL,
                        EXIT_FAILURE);
    ...
    tcase_add_exit_test(tc_helper,
                        test_check_access_permission_exit_group_dn_identifier_x509_info_NULL,
                        EXIT_FAILURE);
    int length_ca_lt = sizeof test_check_access_permission_lt /
                       sizeof test_check_access_permission_lt[0];
    tcase_add_loop_test(tc_helper, test_check_access_permission, 0,
                        length_ca_lt);

    tcase_add_exit_test(tc_helper, test_is_valid_uid_exit_uid_NULL,
                        EXIT_FAILURE);
    int length_ivu_lt = sizeof test_is_valid_uid_lt /
                        sizeof test_is_valid_uid_lt[0];
    tcase_add_loop_test(tc_helper, test_is_valid_uid, 0, length_ivu_lt);

    /* ssh test cases */
    tcase_add_exit_test(tc_ssh, test_pkey_to_authorized_keys_exit_pkey_NULL,
                        EXIT_FAILURE);
    ...
    /* x509 test cases */
    tcase_add_exit_test(tc_x509, test_validate_x509_exit_x509_NULL,
                        EXIT_FAILURE);
    tcase_add_exit_test(tc_x509, test_validate_x509_exit_cacerts_dir_NULL,
                        EXIT_FAILURE);
    tcase_add_exit_test(tc_x509, test_validate_x509_exit_x509_info_NULL,
                        EXIT_FAILURE);
    tcase_add_exit_test(tc_x509,
                        test_validate_x509_exit_x509_cacerts_dir_x509_info_NULL,
                        EXIT_FAILURE);
    int length_validate_x509 = sizeof test_validate_x509_lt /
                               sizeof test_validate_x509_lt[0];
